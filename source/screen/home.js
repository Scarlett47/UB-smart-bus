...
export default function HomeScreen({navigation}) {
  const image = { uri: 'https://th.bing.com/th/id/R.9f5b23664757e4028b9b89851bba13b3?rik=UvFQdb%2bvUHrG8g&riu=http%3a%2f%2f3.bp.blogspot.com%2f_1x1QKjjaEio%2fTB7OyN3-u9I%2fAAAAAAAAAOg%2fu1whqQxFU1E%2fs1600%2fmongoliafirstdays%2b016.jpg&ehk=p2CHrBPIZDuSKmtR0bJTW%2fkFddgOmiBwLBYDhYNs1Uo%3d&risl=&pid=ImgRaw&r=0' };
  return (
      ...
      <View style={styles.smcon}>
        <ImageBackground source={image}>
          <View style={styles.smcon1}>
            <Text style={styles.smtext1}>
              <View style={styles.iconout}>
                <Ionicons name="bus-outline" size={40} style={styles.icon1}></Ionicons>
              </View>
            </Text>
            <Text style={styles.smtext2}>Чиглэл хайх</Text>
            <Text style={styles.smtext3}><Ionicons size={30} name="chevron-forward-outline"></Ionicons></Text>
          </View>
          <View style={styles.smcon2}>
            <Text style={styles.smtext1}>
              <View style={styles.iconout}>
                <MaterialCommunityIcons name="bus-stop-covered" size={40} color="black" style={styles.icon2} />
              </View>
            </Text>
          ...
          <View style={styles.smcon3}>
            <Text style={styles.smtext1}>
              <View style={styles.iconout}>
                <Ionicons name="alert-circle-outline" size={40} style={styles.icon3}></Ionicons>
              </View>
            </Text>
